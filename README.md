...
```
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-fire-f8c3
```

A live public deployment of this template is available at [https://quiet-fire-f8c3.templates.workers.dev](https://quiet-fire-f8c3.templates.workers.dev)
